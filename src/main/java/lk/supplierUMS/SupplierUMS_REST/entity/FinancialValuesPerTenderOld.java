...
@Entity
@Table(name="t_financial_values_per_tender_old")
public class FinancialValuesPerTenderOld implements Serializable {
	...
	@Column(name="t_financial_values_per_tender")
	private Long financialValPerTender;
	
	public Long getFinancialValPerTender() {
		return financialValPerTender;
	}

	public void setFinancialValPerTender(Long financialValPerTender) {
		this.financialValPerTender = financialValPerTender;
	}
